...
- Создал сервисы [Service2.yaml](./files/Service2.yaml) и два ингреса, во втором прописал аннотации canary [Ingress-main.yaml](./files/Ingres-main.yaml), [Ingress-canary.yaml](./files/Ingress-canary.yaml) 
```
[root@sd-k8s-red-node1 lab3.4]# kubectl -n app get svc
NAME             TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)   AGE
